...
import type { CustomRoutes } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/lib/load-custom-routes';
import type { CompilerNameValues } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/shared/lib/constants';
import type { NextConfigComplete } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/server/config-shared';
import type { Span } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/trace';
import type { ProxyMatcher } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/build/analysis/get-page-static-info';
import { type JsConfig, type ResolvedBaseUrl } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/build/load-jsconfig';
import type { NextBuildContext } from '.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/build/build-context';
...
export default function getBaseWebpackConfig(dir: string, { buildId, encryptionKey, config, compilerType, dev, entrypoints, isDevFallback, pagesDir, reactProductionProfiling, rewrites, originalRewrites, originalRedirects, runWebpackSpan, appDir, middlewareMatchers, noMangling, jsConfig, jsConfigPath, resolvedBaseUrl, supportedBrowsers, clientRouterFilters, fetchCacheKeyPrefix, isCompileMode, previewProps, }: {
    ...
    supportedBrowsers: string[] | undefined;
    clientRouterFilters?: {
        staticFilter: ReturnType<import('.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/shared/lib/bloom-filter').BloomFilter['export']>;
        dynamicFilter: ReturnType<import('.bun/next@16.1.0+67f6792bdf102c28/node_modules/next/dist/shared/lib/bloom-filter').BloomFilter['export']>;
    };
