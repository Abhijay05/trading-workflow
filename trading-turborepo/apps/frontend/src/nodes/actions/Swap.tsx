  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        >
          <div className="text-xs opacity-75 mb-1">Direction</div>
        ...
        >
          ...
          <div className="text-lg font-bold font-mono">{data.metadata.qty} USDC.e</div>
        </div>
        <div
          className={`${
            isLong ? "bg-green-900/50" : "bg-red-900/50"
        ...
        >
          <div className="text-xs opacity-75 mb-1">Asset</div>
          <div className="text-lg font-bold font-mono">
            {data.metadata.symbol || "CRO"}
          </div>
        </div>
      </div>
